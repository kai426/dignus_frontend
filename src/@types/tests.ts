...
export interface TestSettingsDto {
  portugueseReadingTimeSeconds: number;
  portugueseInterpretationTimeSeconds: number;
  portuguesePreparationTimeSeconds: number;
  // ... outros tempos, se houver
}
...
export interface TestInstanceDto {
  ...
  testSettings?: TestSettingsDto | null;
}
